(function (root) {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .benchmark-finding { margin-top: 7px; border-left: 2px solid var(--progress); padding-left: 7px; color: var(--progress); font-size: 9px; line-height: 1.4; overflow-wrap: anywhere; }
  ...
  function resultSummaryText(run) {
    if (run?.status === 'Completed') {
      ...
      return finding ? `Notable finding: ${finding}` : 'Notable finding: Not recorded.';
    }
